...
public record BookingResponse(
        ...
        double amountTotal,
        double amountVenue,
        double amountHostCredit,
        double amountPlatform,
        String currency,
    ...
    public static BookingResponse from(Booking b) {
        ...
        return new BookingResponse(
                ...
                b.getAmountTotal(), b.getAmountVenue(), b.getAmountHostCredit(), b.getAmountPlatform(),
                b.getCurrency(), b.getStripePaymentIntentId(),
