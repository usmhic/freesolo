...
[GitHub private vulnerability reporting](https://github.com/usmhic/freesolo/security/advisories/new)
and include the affected commit or version, reproduction steps, impact, and a
suggested mitigation when possible.

Remove credentials, personal data, payment details, and production logs from the
